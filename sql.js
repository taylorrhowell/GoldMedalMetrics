...
const createGoldMedalTable = () => {
  return 'CREATE TABLE "GoldMedal" ("id" INTEGER NOT NULL, "year" INTEGER NOT NULL, "city" TEXT NOT NULL, "season" TEXT NOT NULL, "name" TEXT NOT NULL, "country" TEXT NOT NULL, "gender" TEXT NOT NULL, "sport" TEXT NOT NULL, "discipline" TEXT NOT NULL, "event" TEXT NOT NULL, PRIMARY KEY("id" AUTOINCREMENT));';
};
